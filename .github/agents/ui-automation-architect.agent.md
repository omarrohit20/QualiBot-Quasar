...
description: Writes and refactors Playwright TypeScript UI automation code — page objects, data factories, facades, builders, strategies, and spec files. Use when asked to add/refactor a page object, reduce duplication across a multi-step UI flow, or add configurable test data.
